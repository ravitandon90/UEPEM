%
function total_Energy = run_EPEM (Packet_Size, Packet_Transmission_Cost, Amplification_Energy_Multi_Path, Energy_Data_Aggregation, Num_Sensors, Area_Net, Radius_Net, M)
r = Radius_Net/M;
Area_ring = zeros (M, 1);
